...
def _build_football_prompt(foot: dict) -> str:
    ...
    return (
        ...
        "REGOLA QUOTA FERREA: scegli la giocata SOLO dalla lista 'giocate_valore' di ogni partita. "
        "Quelle quote sono GIA tutte >= 1.90 (filtrate). NON inventare quote, NON scendere sotto 1.90. "
        "Usa esattamente mercato, selezione e quota da quella lista.\n"
        "Varia i mercati nei giorni: Over/Under, Gol Gol, Multigol Casa, Multigol Ospite, "
        "Over/Under 1° e 2° Tempo, Doppia Chance, Handicap, Pari/Dispari, Numero Gol Esatto, "
        "Over+Gol Gol, e quando presenti Calci d'Angolo, Tiri in Porta, Fuorigioco. "
        "I multigol (es. Multigol Casa 1-2, Multigol Ospite 1-3) e le combo hanno quote belle: valutali.\n"
        "Scegli la giocata che le STATISTICHE (forma, attacco, difesa, gol attesi) supportano meglio.\n\n"
        "REGOLA COERENZA (FONDAMENTALE - non sbagliare): la giocata DEVE essere logica con l'analisi. "
        "Se una squadra DOMINA (attacco molto piu alto, avversario debole): la sua quota e bassa. "
        "NON consigliare Doppia Chance o Vincente sul favorito a quota alta (e impossibile/sbagliato). "
        "Su partite squilibrate, il valore ≥1.90 sta nei mercati GOL: Over 2.5, Gol Gol, "
        "Over Calci d'Angolo, Tiri, NON nell'esito. Esempio: se Brasile schiaccia, vai 'Over 2.5' "
        "o 'Brasile segna almeno 2 gol', MAI 'Doppia Chance Brasile' a quota 2.45.\n"
        "Verifica sempre: la quota della giocata ha senso col favorito? Se no, cambia mercato.\n\n"
        "COME RAGIONARE (usa i dati reali forniti):\n"
        "- Forma squadre (W/L/D ultimi 5), forza attacco/difesa, gol attesi\n"
        "- Squadra domina nettamente -> Over 2.5 / Over angoli / la favorita segna molto (NO doppia chance favorita)\n"
        "- Match equilibrato -> Gol Gol, Over 2.5, o Doppia Chance dell'underdog\n"
        "- Difese deboli entrambe -> Over 2.5 o Gol Gol\n\n"
        "NOMI SQUADRE: SEMPRE in italiano. Scotland=Scozia, Brazil=Brasile, England=Inghilterra, "
        "Spain=Spagna, Germany=Germania, Switzerland=Svizzera, Croatia=Croazia, Portugal=Portogallo, "
        "Senegal=Senegal, Norway=Norvegia, Canada=Canada. Traduci sempre nel titolo e nella voce.\n\n"
        "DIVISIONE CONTENUTO:\n"
        ...
        "STILE VOCE — parla come un amico esperto che ti passa la dritta, naturale e sicuro. "
        "NON robotico, NON elenco. Frasi che scorrono, un po' di pausa, come una chiacchiera al bar. "
        "Usa intercalari naturali: 'senti', 'guarda', 'ti dico', 'fidati'. Crea complicita.\n\n"
        "STRUTTURA VOCE (parlato naturale, non a punti):\n"
        "1. AGGANCIO: nomina la partita con un'opinione. Es: 'Senti, su Inghilterra-Ghana c'e una cosa che pochi notano.'\n"
        "2. LA DRITTA: dai la giocata con sicurezza. Es: 'Io me la gioco col Gol Gol, quota uno e novantacinque, e ti spiego al volo perche.'\n"
        "3. MEZZA RAGIONE: UNA frase del perche (non tutto). Es: 'Segnano tutte e due da settimane, e qui non cambia.'\n"
        "4. RIMANDO: 'L'analisi completa te la lascio qui sotto, leggila prima di buttarti.'\n"
        "5. CHIUSURA COMPLICE: 'Seguimi, domani un'altra dritta.'\n\n"
        "HOOK_TEXT: testo gigante schermo primi 2s. La giocata + quota. Es: 'GOL GOL 1.95' o 'OVER 2.5 a 2.10'.\n\n"
        "REGOLE VOCE TTS italiano (CRUCIALE per suono naturale):\n"
        "- Quote a voce in lettere: 'uno e novantacinque' per 1.95, 'due e dieci' per 2.10\n"
        "- Usa virgole per le pause naturali del parlato\n"
        "- Tono caldo, sicuro, complice — un amico che sa di calcio, non un robot\n"
        "- Zero abbreviazioni, niente numeri in cifre\n\n"
